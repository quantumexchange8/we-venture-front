        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="box-account">
                    <li class="login">
                        <a href="https://login.clarkwell.co/welcome" target="_blank" title="">@lang('public.login')</a>
                    </li>
                    <li class="sign-in">
                        <a href="https://login.clarkwell.co/register" target="_blank" title="">@lang('public.signup')</a>
                    </li>
                </ul><!-- /.box-account -->
